...
SECRET_KEY = "e9vmi&(8a!p=p%882yt2&6qa4cqf!thn+4x=pz#k)8e&igj^9f"
...
SOCIAL_AUTH_FACEBOOK_SCOPE = ['email', 'fullname']
SOCIAL_AUTH_FACEBOOK_PROFILE_EXTRA_PARAMS = {
    'fields': 'id, name, email, age_range, education'}

SOCIAL_AUTH_FACEBOOK_KEY = os.environ.get("SOCIAL_AUTH_FACEBOOK_KEY")
SOCIAL_AUTH_FACEBOOK_SECRET = os.environ.get(
    "SOCIAL_AUTH_FACEBOOK_SECRET")
SOCIAL_AUTH_GOOGLE_OAUTH2_SCOPE = ['profile_fullname', ]
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'server.pipeline.get_avatar',
)

###

MAX_OF_PROFILES = os.environ.get('MAX_OF_PROFILES', 3)
MAX_OF_GALLERY_PHOTOS = os.environ.get('MAX_OF_GALLERY_PHOTOS', 48)
