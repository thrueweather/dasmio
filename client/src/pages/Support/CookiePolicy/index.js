...
const CookiePolicy = () => {
  return (
    <Wrapp>
      ...
      <h4>Introduction</h4>
      <p>
        Dasmio is committed to protecting your privacy. We aim to provide
        ...
        we've tried to keep legal and technical jargon to a minimum.
      </p>
      <p>
        This Cookie Policy explains what cookies are, what types of cookies are
        placed on your device when you visit our website and how we use them.
        This Cookie Policy does not address how we deal with your personal
        information generally. To learn more about how we process your personal
        information, please see our Privacy Policy here.
      </p>
      <h4>What are cookies</h4>
      <p>
        Cookies are small text files that are sent to or accessed from your web
        browser or your device’s memory. A cookie typically contains the name of
        the domain (internet location) from which the cookie originated, the
      ...
      <p>
        ...
        which function like cookies and web beacons.
      </p>
      ...
      <h5>Browser and devices controls</h5>
      <p>
      ...
      <p>
        ...
        appropriate setting on your mobile device. The procedure for managing
        device identifiers is slightly different for each device. You can check
        the specific steps in the help or settings menu of your particular
        device.{" "}
      </p>
      <h5>Interest-based advertising tools</h5>
      <p>
        You can opt out of seeing online interest-based advertising from
        participating companies through the Digital Advertising Alliance, the
        Interactive Digital Advertising Alliance or Appchoices (apps only).
      </p>
      <p>
      ...
      <p>
        To learn more about social media cookies, we suggest you refer to your
        social media platform’s cookie policy and privacy policy.
      </p>
      <h4>Adobe Flash Player™ Flash cookies</h4>
      <p>
        Adobe Flash Player™ is an application for viewing and interacting with
        dynamic content using the Flash platform. Flash (and similar
        applications) use a technology akin to cookies to memorize parameters,
        preferences and uses of this content. However, Adobe Flash Player
        manages this information and your choices via an interface separate from
        that supplied by your browser.
      </p>
      <p>
        If your terminal is likely to display content developed using the Flash
        platform, we suggest you access your Flash cookie management tools
        directly via https://www.adobe.com.
      </p>
      <h4>Google™ Cookies</h4>
      <h5>Google™ Maps API Cookies</h5>
      <p>
        Some features of our website and some Tinder services rely on the use of
        ...
        that supplied by your browser. For more information, please see
      ...
      <p>
        ...
        of the website and services in order to report website trends.
      </p>
      <p>
